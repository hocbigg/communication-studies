...
| --- | --- | --- |
| Classical & Contemporary Rhetorical Theory | Deconstructs how language and symbolic action shape public reality, tracing the evolution from Aristotelian proofs and Ciceronian canons to Kenneth Burke's dramatism and Michel Foucault's discursive power. | *The SAGE Handbook of Rhetorical Studies* (Lunsford, Wilson, & Eberly, SAGE)<br>- [Silva Rhetoricae: The Forest of Rhetoric](https://rhetoric.byu.edu/) (Brigham Young University)<br>- [HarvardX: Rhetoric – The Art of Persuasive Writing and Public Speaking](https://www.edx.org/learn/rhetoric/harvard-university-rhetoric-the-art-of-persuasive-writing-and-public-speaking) |
| Political Communication & Deliberative Democracy | Analyzes how political campaigns, news framing, electoral debate, and the Habermasian public sphere facilitate or hinder democratic deliberation and civic participation. | *Handbook of Political Communication Research* (Lynda Lee Kaid, Routledge)<br>- *The Structural Transformation of the Public Sphere* (Jürgen Habermas, MIT Press)<br>- *Public Opinion* (Walter Lippmann) |
...
| Topic | Why Study | Resources |
| --- | --- | --- |
| Platform Studies & Algorithmic Governance | Analyzes how digital platform infrastructure, algorithmic recommendation systems, curation protocols, and content moderation policies govern public attention and social behavior. | *Custodians of the Internet: Platforms, Content Moderation, and the Hidden Decisions That Shape Social Media* (Tarleton Gillespie, Yale University Press)<br>- *The Platform Society: Public Values in a Connective World* (van Dijck, Poell, & de Waal, Oxford University Press) |
...
| Topic | Why Study | Resources |
| --- | --- | --- |
| Organizational Discourse & CCO Theory | Examines how communication constitutively builds organizations (Communicative Constitution of Organizations), Karl Weick's sensemaking theory, organizational culture, and workplace power dynamics. | *The SAGE Handbook of Organizational Communication: Advances in Theory, Research, and Methods* (Putnam & Mumby, SAGE)<br>- *Sensemaking in Organizations* (Karl E. Weick, SAGE) |
| Strategic Communication Planning & PR | Masters the strategic planning process, stakeholder identification, public relations campaign architecture, corporate advocacy, and reputational equity management. | *Strategic Planning for Public Relations* (Ronald D. Smith, Routledge)<br>- [Coursera: Integrated and Strategic Communication Campaigns](https://www.coursera.org/learn/integrated-and-strategic-communication-campaigns) (University of Colorado Boulder) |
...
| Topic | Why Study | Resources |
| --- | --- | --- |
| Health Behavior Campaigns & Message Design | Explores evidence-based public health interventions using the Health Belief Model, Theory of Planned Behavior, Extended Parallel Process Model (EPPM), and narrative persuasion. | *The Routledge Handbook of Health Communication* (Thompson & Harrington, Routledge)<br>- *Public Communication Campaigns* (Rice & Atkin, SAGE) |
| Patient-Provider Interaction & Health Disparities | Analyzes clinical interpersonal communication, shared medical decision-making, health literacy, intercultural care delivery, and communicative determinants of health equity. | *Communicating with Medical Patients* (Stewart & Roter, SAGE)<br>- *Health Communication: A Cultural Approach* (Mohan J. Dutta, Polity) |
...
| Topic | Why Study | Resources |
| --- | --- | --- |
| Political Economy of Media & Cultural Industries | Investigates media ownership concentration, commercialization, institutional monopolies, and the structural political-economic determinants of mass cultural production. | *Manufacturing Consent: The Political Economy of the Mass Media* (Herman & Chomsky, Pantheon Books)<br>- *The Cultural Industries* (David Hesmondhalgh, SAGE) |
